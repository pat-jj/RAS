...
#     --checkpoint_path /shared/rsaas/pj20/firas_data/multitask/checkpoints/latest_checkpoint.safetensors \
...
# /shared/rsaas/pj20/firas_data/multitask/ckpt_ptune/latest_checkpoint_epoch_lora_True.safetensors
# export CUDA_VISIBLE_DEVICES=0,1
python test_answerer.py \
    --checkpoint_path /shared/rsaas/pj20/firas_data/multitask/checkpoints_20/checkpoint_7_of_20.safetensors \
    --test_data_path /shared/eng/pj20/firas_data/test_datasets/answerer/triviaqa_test_output_llama2-7b_sonnet_answerer_data.pkl \
    --output_path /shared/eng/pj20/firas_data/test_datasets/results/graphllm_triviaqa_answerer_test_results_all_graph_10_20.json \
    --finetune_method lora \
    --llm_frozen False \
    --batch_size 1
...
python test_answerer.py \
    ...
    --output_path /shared/eng/pj20/firas_data/test_datasets/results/graphllm_2wikimultihop_answerer_test_results_all_graph_10_20.json \
    --finetune_method lora \
    --llm_frozen False \
    --batch_size 1
...
python test_answerer.py \
    ...
    --output_path /shared/eng/pj20/firas_data/test_datasets/results/graphllm_pubhealth_answerer_test_results_all_graph_10_20.json \
    --finetune_method lora \
    --llm_frozen False \
    --batch_size 1
...
python test_answerer.py \
    --checkpoint_path /shared/rsaas/pj20/firas_data/multitask/checkpoints_20/checkpoint_7_of_20.safetensors \
    --test_data_path /shared/eng/pj20/firas_data/test_datasets/answerer/asqa_test_output_sonnet_sonnet_answerer_data.pkl \
    --output_path /shared/eng/pj20/firas_data/test_datasets/results/graphllm_asqa_answerer_test_results_all_graph_10_20.json \
    --finetune_method lora \
    --llm_frozen False \
    --batch_size 1
...
python test_answerer.py \
    ...
    --output_path /shared/eng/pj20/firas_data/test_datasets/results/graphllm_eli5_answerer_test_results_all_graph_10_20.json \
    --finetune_method lora \
    --llm_frozen False \
    --batch_size 1

# python test_answerer.py \
#     --checkpoint_path /shared/rsaas/pj20/firas_data/multitask/ckpt_ptune/latest_checkpoint_epoch_lora_True.safetensors \
...
#     --checkpoint_path /shared/rsaas/pj20/firas_data/multitask/ckpt_no_graph/latest_checkpoint_epoch_lora_False_nograph.safetensors \
#     --test_data_path /shared/eng/pj20/firas_data/test_datasets/answerer/triviaqa_test_output_llama2-7b_sonnet_answerer_data.pkl \
